    ...
    return (
        <div className="flex justify-center items-center mt-10">
            <div class=" border border-black rounded-lg p-8 sm:w-90 lg:w-96">
                ...
                <h2 className="text-2xl font-bold mb-7 text-center">Login Page</h2>
                ...
                <p className="text-center mt-2.5">Don't have an Account? <Link to="/signup" className="text-red-500">Register</Link></p>
            </div>
        </div>
    );
};
